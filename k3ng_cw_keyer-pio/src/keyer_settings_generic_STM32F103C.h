...
#define number_of_memories byte(10) // sp5iou 20180329 With many memories, be carefull to not put to much content. It could disable memory programming and eeprom formatting is then necessary
#endif
...
#define custom_startup_field "your custom text here" // an example could be callsign and name, eg. "AB1XYZ Bob", (or "Worlds best operator" which requires a 20 column display), string length should be no more than the number of columns on the display
