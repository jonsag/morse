...
// 2016-09-28 this is removed from other features files - may deprecate totally - #define OPTION_WINKEY_SEND_BREAKIN_STATUS_BYTE       // additional code to check_dit_paddle() and check_dah_paddle() to send 0xC2 status byte when paddles are hit
// 2023-09-28 re-adding as a default to all hardware profiles.  if you don't have it activated paddle interruption of CQ repeat in N1MM doesn't work
...
// #define OPTION_DISPLAY_NON_ENGLISH_EXTENSIONS  // LCD display support for non-English (NO/DK/DE) characters - Courtesy of OZ1JHM
